export const initialReportData = {
  header: {
    ...
    period: "22 a 28 de Junho de 2026"
  },
  general: {
    engagement: { value: "2,14%", prev: "2,68%", growth: "-20,15%", isPositive: false },
    publications: { value: 101, prev: 50, growth: "+102,00%", isPositive: true },
  ...
  channels: [
    {
      ...
      metrics: {
        engagement: { value: "2,43%", prev: "1,51%", growth: "+60,93%", isPositive: true },
        followers: { value: "1.838.576", growth: "+0,02%", isPositive: true },
        pubs: { value: 18, prev: 8, growth: "+125,00%", isPositive: true },
        impressions: { value: "270.727", prev: "79.586", growth: "+240,17%", isPositive: true },
        interactions: { value: "6.895", prev: "783", growth: "+780,59%", isPositive: true }
      }
    },
    {
      id: "instagram-feed",
      ...
      metrics: {
        engagement: { value: "1,03%", prev: "1,17%", growth: "-11,97%", isPositive: false },
        followers: { value: "4.452.025", growth: "+0,19%", isPositive: true },
        pubs: { value: 31, prev: 15, growth: "+106,67%", isPositive: true },
        impressions: { value: "2.313.585", prev: "997.364", growth: "+131,97%", isPositive: true },
        interactions: { value: "17.455", prev: "9.368", growth: "+86,33%", isPositive: true }
      }
    },
    {
      ...
      metrics: {
        engagement: { value: "3,03%", prev: "4,50%", growth: "-32,67%", isPositive: false },
        followers: { value: "4.452.025", growth: "+0,19%", isPositive: true },
        pubs: { value: 38, prev: 17, growth: "+123,53%", isPositive: true },
        impressions: { value: "2.848.108", prev: "1.486.745", growth: "+91,57%", isPositive: true },
        interactions: { value: "77.192", prev: "58.886", growth: "+31,09%", isPositive: true }
      }
    },
    {
      id: "tiktok",
      ...
      metrics: {
        engagement: { value: "2,08%", prev: "3,54%", growth: "-41,24%", isPositive: false },
        followers: { value: "111.600", growth: "+1,44%", isPositive: true },
        pubs: { value: 14, prev: 10, growth: "+40,00%", isPositive: true },
        impressions: { value: "996.889", prev: "278.116", growth: "+258,4%", isPositive: true },
        interactions: { value: "8.897", prev: "2.995", growth: "+197,06%", isPositive: true }
      }
    }
  ],
  behavior: {
  ...
  insights: [
    {
      ...
      desc: "O grande marco do período foi a espetacular tração de alcance multiplataforma gerada pela convergência entre a linha de conteúdo proprietária Cozinha Assaí (com receitas virais juninas) e as grandes frentes comerciais de varejo (Casa do Patrão, Acelera com Preço Baixo e Dia Imbatível). Juntas, as linhas de culinária regional e as ativações institucionais de patrocínio foram os maiores motores de visibilidade da marca, quebrando recordes de exposição ao acumular quase 1 milhão de visualizações consolidadas no TikTok e ultrapassar a marca de 4 milhões de impressões combinadas no ecossistema Meta. Esse fenômeno demonstra que o público respondeu massivamente aos conteúdos sazonais de fim de junho, posicionando a marca com força total na mente dos consumidores durante um período de alta competitividade no mercado varejista.",
      icon: "Users",
      type: "neutral"
    },
    {
      title: "Estratégias de Sucesso",
      desc: "A estratégia mais assertiva e de maior retorno em engajamento foi o uso de formatos promocionais escassos e de urgência tática (\"É amanhã\" e \"É hoje\") distribuídos via Instagram Stories e Facebook, aliados ao formato de receitas dinâmicas com microinfluenciadores no Feed. No Instagram Stories, as campanhas \"Imbatível\" e \"Acelera\" registraram eficiência histórica, batendo médias de engajamento extraordinárias de 10,96% e 7,25%, respectivamente, com picos de alcance unitário acima de 70 mil usuários por tela. No ambiente do Facebook, o anúncio \"Prepare-se\" para o Dia Imbatível isolou-se como um sucesso de tração ao alcançar sozinho mais de 55 mil pessoas com um engajamento saudável de 4,66%. Complementando o sucesso comercial, o Reels \"Canjica com Oreo\" na Cozinha Assaí provou o poder do conteúdo de entretenimento útil ao disparar o engajamento do feed para 6,49%, equilibrando perfeitamente grande alcance com retenção ativa.",
      icon: "TrendingUp",
      type: "positive"
    },
    {
      title: "Alerta",
      desc: "O principal ponto de atenção e sinal de alerta para a marca reside no fenômeno da \"inflação de visualizações com passividade\", identificado nas linhas editoriais de maior distribuição em formato de vídeo vertical (TikTok e Reels no Instagram Feed). No TikTok, embora o hub da Cozinha Assaí tenha acumulado impressionantes 770.083 visualizações totais, a sua taxa média de engajamento real ficou estagnada em apenas 0,69%; cenário ainda mais crítico foi observado no post isolado da \"Casa do Patrão\", que entregou robustas 207 mil visualizações, mas despencou para um índice de engajamento alarmante de 0,24%. Da mesma forma, no feed do Instagram, o Reels do \"Cuscuz\" obteve um alcance massivo de mais de 213 mil pessoas, mas sua taxa de conversão em interações caiu para 0,95%. Essa disparidade escancara que o algoritmo de recomendação está distribuindo amplamente as produções gastronômicas e corporativas, mas a audiência está consumindo o conteúdo de forma 100% passiva, sem curtir, comentar ou salvar.",
      icon: "AlertOctagon",
      type: "negative"
    },
    {
      title: "Correlação com o Mercado",
      desc: "O comportamento dos dados desta semana reflete com precisão as movimentações contemporâneas do Social Commerce e do Atacarejo, onde as redes líderes de mercado deixaram de ser meros panfleteiros de ofertas para se transformarem em grandes publishers de conteúdo comunitário. O estrondoso alcance bruto da Cozinha Assaí demonstra como o varejo de grande volume precisa se apropriar de datas culturais (como o São João) para gerar valor de marca (brand equity) antes de empurrar a venda direta. Em paralelo, a explosão de interações e os picos de engajamento em conteúdos efêmeros (Instagram Stories promocionais) validam a tendência global de comportamento do consumidor moderno, que rejeita posts comerciais fixos e estáticos, mas reage de forma imediata e impulsiva a cupons digitais e ofertas-relâmpago limitadas que ativam o gatilho psicológico do FOMO (Fear of Missing Out / Medo de perder a oportunidade).",
      icon: "Target",
      type: "neutral"
    },
    {
      title: "Foco para Próximas Produções",
      desc: "Para os próximos ciclos de criação, as produções devem focar obrigatoriamente na criação de mechanisms de interatividade para converter o grande alcance passivo em engajamento real. É indispensável que os vídeos de alta entrega, como as receitas da Cozinha Assaí, passem a incluir de forma nativa camadas de gamificação — tais como enquetes de votação nos Stories, chamadas explícitas para salvar o post no Feed ou perguntas provocativas na legenda do TikTok que forcem o clique na aba de comentários. Por fim, grandes frentes como a \"Casa do Patrão\" precisam abandonar o formato engessado de comerciais tradicionais de televisão e passar a ser roteirizados na linguagem ágil de collabs e transições dinâmicas, utilizando influenciadores parceiros e funcionários de loja locais para humanizar a mensagem institucional e aproximar o cliente da conversão final no aplicativo.",
      icon: "Lightbulb",
      type: "focus"
    }
  ],
  ...
  campaigns: [
    ...
    { name: 'Dia Imbatível', reach: '332.487', eng: '4,69%', imp: '464.328', views: '0', clicks: '19.597', traffic: '0' },
    { name: 'Copa da Torcida', reach: '229.305', eng: '3,58%', imp: '283.362', views: '0', clicks: '8.410', traffic: '0' }
  ],
  networkView: {
    learnings: [
  ...
  tiktokView: {
    ...
    panel: {
      views: '996.889',
      viewsComp: '+258,4% vs. 278.116 do período anterior',
      engagement: '2,08%',
      engagementComp: '-41,24% vs. 3,54% do período anterior',
      posts: '14',
      postsComp: '+40% vs. 10 do período anterior',
      interactions: '8.897',
      interactionsComp: '-197,06% vs. 2.995 do período anterior',
      videoViews: '6,5s',
      videoViewsComp: '',
    ...
    champions: [
      {
        title: 'Campeão em Performance: Categoria RELACIONAL – Funcionário de loja | Copa Junina',
        desc: '1.166 Visualizações | 55 Interações | 4,72% Engajamento',
        link: 'https://www.tiktok.com/@assaiatacadistaoficial/video/7655008012121263376',
        image: 'https://i.imgur.com/Zxrtbnf.png',
        factors: [
            { num: '1', title: 'Por que funcionou', desc: 'O tema associado a dois momentos sazonais ativou de forma agressiva as engrenagens de distribuição em massa do TikTok, gerando um alcance massivo de visualizações no meio da semana.' }
        ]
      }
    ],
    categories: {
  ...
  facebookView: {
    ...
    panel: {
      reach: '198.915',
      reachComp: '+278,9% comparado ao período anterior de 52.495',
      engagement: '2,43%',
      engagementComp: '+60,9% comparado ao período anterior de 1,51%',
      impressions: '270.727',
      impressionsComp: '+240,2% comparado ao período anterior de 79.586',
      posts: '18',
      postsComp: '+125% comparado ao período anterior de 8',
      interactions: '6.895',
      interactionsComp: '+780,5% comparado ao período anterior de 783',
    ...
    champions: [
      {
        title: 'Carrossel de OFERTAS – Grupo: É Amanhã (Subgrupo: Acelera com Preço Baixo)',
        desc: '5,22% de Engajamento | 1.251 Interações | 29.253 Impressões (Visualizações) | 23.957 de Alcance',
        link: 'https://www.facebook.com/reel/1649065959915431/',
        image: 'https://i.imgur.com/t8gATIT.png',
        factors: [
             { num: '1', title: 'Por que funcionou', desc: 'O conteúdo ativou com precisão o gatilho de interesse e o sentimento de torcida associado à Copa Junina. Ao sugerir os usuários bebidas para aproveitar e comemorar, o post estimulou um diálogo orgânico intenso que sinalizou relevância imediata para o algoritmo do Facebook.' }
        ]
      }
    ],
    categories: {
  ...
  instagramFeedView: {
    ...
    panel: {
      reach: '1.686.570',
      reachComp: '+137,66% em comparação ao período anterior (709.665)',
      engagement: '1,03%',
      engagementComp: '-11,97% comparado ao patamar anterior (1,17%)',
      impressions: '2.313.585',
      impressionsComp: '+131,97% frente ao volume anterior (997.364)',
      posts: '31',
      postsComp: '+106,67% no inventário da grade (anterior foi de 15)',
      interactions: '17.455',
      interactionsComp: '+86,33% (anterior foi de 9.368)',
      reposts: '1.554',
      repostsComp: '+135,10% em relação ao ciclo anterior (661)',
      videoViews: '7,5s',
      videoViewsComp: 'Desempenho consolidado com média de 7,5 segundos de atenção qualificada nos formatos audiovisuais.',
    ...
    champions: [
      {
        title: 'Entretenimento | Subgrupo: Copa Junina',
        desc: '6,49% de Engajamento | 2.314 Interações totais | 35.661 Impressões (Visualizações) | Data: 23/06/2026 (Terça-feira)',
        link: 'https://www.instagram.com/reel/DZ7t0LzhEsc/',
        image: 'https://i.imgur.com/dPdGoJu.png',
        factors: [
             { num: '1', title: 'Por que funcionou', desc: 'O conteúdo de melhor performance da semana ao cruzar a paixão por receitas típicas das Festas Juninas com uma marca parceira amada pelo público (Oreo). A dinâmica em Reels, aliada ao apelo altamente visual da culinária afetiva, gerou desejo instantâneo e transformou o post em um polo gerador de engajamento nativo e conversas orgânicas.' }
        ]
      }
    ],
    categories: {
  ...
  instagramStoriesView: {
    ...
    panel: {
      reach: '2.392.739',
      reachComp: '+90,4% em relação ao período anterior (1.256.464) (apresentando uma leve retração)',
      engagement: '3,03%',
      engagementComp: '-32,6% comparado ao patamar anterior (4,50%) (registrando um crescimento espetacular)',
      impressions: '2.848.108',
      impressionsComp: '+91,6% frente ao volume ocioso anterior (1.486.745) (o que representa uma queda)',
      posts: '38',
      postsComp: '+123,5% no inventário de telas distribuídas (anterior foi de 17) (um corte estratégico)',
      interactions: '77.192',
      interactionsComp: '+31,1% (anterior foi de 58.886) (um salto expressivo)',
    ...
    champions: [
      {
        title: 'Campanha (Categoria: OFERTAS / É Amanhã | Acelera com Preço Baixo)',
        desc: '13,9% de Engajamento | 9.364 Cliques e Interações diretas | 95.200 Impressões | 67.228 de Alcance | Data: 25/06/2026 (Quinta-feira)',
        link: 'https://w....',
        image: 'https://i.imgur.com/cGFo6OC.png',
        factors: [
  ...
  onePage: {
    ...
    overview: {
      ...
      fb: { engagement: "2,43%", tag: "+60,93%", isUp: true },
      tk: { engagement: "2,08%", tag: "-41,24%", isUp: false },
    ...
    instagramDetails: {
      ...
      mockups: [
        { label: "Feed - ENG: 1,03%", imageUrl: "https://i.imgur.com/cGFo6OC.png" },
        { label: "Stories - ENG: 3,03%", imageUrl: "https://i.imgur.com/cGFo6OC.png" }
      ]
    },
    facebookDetails: {
      ...
      mockups: [
        { label: "ENG: 2,43%", imageUrl: "https://i.imgur.com/UD5LNWh.png" }
      ]
    },
    tiktokDetails: {
      ...
      mockups: [
        { label: "ENG: 2,08%", imageUrl: "https://i.imgur.com/Zxrtbnf.png" }
      ]
    },
    pillars: [
      {
